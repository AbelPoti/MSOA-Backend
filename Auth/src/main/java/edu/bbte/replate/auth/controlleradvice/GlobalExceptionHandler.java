...
import edu.bbte.replate.auth.dto.outgoing.SimpleMessageResponseDto;
import edu.bbte.replate.auth.dto.outgoing.ValidationErrorResponseDto;
import edu.bbte.replate.auth.exception.BadRequestException;
import edu.bbte.replate.auth.exception.InternalServerErrorException;
import edu.bbte.replate.auth.exception.ResourceNotFoundException;
